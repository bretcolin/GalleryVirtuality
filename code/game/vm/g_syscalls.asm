...
line 419
;419:	syscall( BOTLIB_EA_SELECT_WEAPON, client, weapon );
CNSTI4 416
ARGI4
ADDRFP4 0
INDIRI4
...
line 422
;421:
;422:void trap_EA_Jump(int client) {
line 423
;423:	syscall( BOTLIB_EA_JUMP, client );
CNSTI4 417
ARGI4
ADDRFP4 0
INDIRI4
...
line 426
;425:
;426:void trap_EA_DelayedJump(int client) {
line 427
;427:	syscall( BOTLIB_EA_DELAYED_JUMP, client );
CNSTI4 418
ARGI4
ADDRFP4 0
INDIRI4
...
line 430
;429:
;430:void trap_EA_Move(int client, vec3_t dir, float speed) {
line 431
;431:	syscall( BOTLIB_EA_MOVE, client, dir, PASSFLOAT(speed) );
ADDRFP4 8
INDIRF4
ARGF4
ADDRLP4 0
...
line 434
;433:
;434:void trap_EA_View(int client, vec3_t viewangles) {
line 435
;435:	syscall( BOTLIB_EA_VIEW, client, viewangles );
CNSTI4 420
ARGI4
ADDRFP4 0
INDIRI4
...
line 438
;437:
;438:void trap_EA_EndRegular(int client, float thinktime) {
line 439
;439:	syscall( BOTLIB_EA_END_REGULAR, client, PASSFLOAT(thinktime) );
ADDRFP4 4
INDIRF4
ARGF4
ADDRLP4 0
...
line 442
;441:
;442:void trap_EA_GetInput(int client, float thinktime, void /* struct bot_input_s */ *input) {
line 443
;443:	syscall( BOTLIB_EA_GET_INPUT, client, PASSFLOAT(thinktime), input );
ADDRFP4 4
INDIRF4
ARGF4
ADDRLP4 0
...
line 446
;445:
;446:void trap_EA_ResetInput(int client) {
line 447
;447:	syscall( BOTLIB_EA_RESET_INPUT, client );
CNSTI4 423
ARGI4
ADDRFP4 0
INDIRI4
...
line 450
;449:
;450:int trap_BotLoadCharacter(char *charfile, float skill) {
line 451
;451:	return syscall( BOTLIB_AI_LOAD_CHARACTER, charfile, PASSFLOAT(skill));
ADDRFP4 4
INDIRF4
ARGF4
ADDRLP4 0
...
;452:}
;453:
;454:void trap_BotFreeCharacter(int character) {
line 455
;455:	syscall( BOTLIB_AI_FREE_CHARACTER, character );
CNSTI4 501
ARGI4
ADDRFP4 0
INDIRI4
...
line 458
;457:
;458:float trap_Characteristic_Float(int character, int index) {
line 460
;459:	int temp;
;460:	temp = syscall( BOTLIB_AI_CHARACTERISTIC_FLOAT, character, index );
CNSTI4 502
ARGI4
ADDRFP4 0
INDIRI4
...
;462:}
;463:
;464:float trap_Characteristic_BFloat(int character, int index, float min, float max) {
line 466
;465:	int temp;
;466:	temp = syscall( BOTLIB_AI_CHARACTERISTIC_BFLOAT, character, index, PASSFLOAT(min), PASSFLOAT(max) );
ADDRFP4 8
INDIRF4
ARGF4
ADDRLP4 4
...
;468:}
;469:
;470:int trap_Characteristic_Integer(int character, int index) {
line 471
;471:	return syscall( BOTLIB_AI_CHARACTERISTIC_INTEGER, character, index );
CNSTI4 504
ARGI4
ADDRFP4 0
INDIRI4
...
;472:}
;473:
;474:int trap_Characteristic_BInteger(int character, int index, int min, int max) {
line 475
;475:	return syscall( BOTLIB_AI_CHARACTERISTIC_BINTEGER, character, index, min, max );
CNSTI4 505
ARGI4
ADDRFP4 0
INDIRI4
...
;476:}
;477:
;478:void trap_Characteristic_String(int character, int index, char *buf, int size) {
line 479
;479:	syscall( BOTLIB_AI_CHARACTERISTIC_STRING, character, index, buf, size );
CNSTI4 506
ARGI4
ADDRFP4 0
INDIRI4
...
line 482
;481:
;482:int trap_BotAllocChatState(void) {
line 483
;483:	return syscall( BOTLIB_AI_ALLOC_CHAT_STATE );
CNSTI4 507
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;484:}
;485:
;486:void trap_BotFreeChatState(int handle) {
line 487
;487:	syscall( BOTLIB_AI_FREE_CHAT_STATE, handle );
CNSTI4 508
ARGI4
ADDRFP4 0
INDIRI4
...
line 490
;489:
;490:void trap_BotQueueConsoleMessage(int chatstate, int type, char *message) {
line 491
;491:	syscall( BOTLIB_AI_QUEUE_CONSOLE_MESSAGE, chatstate, type, message );
CNSTI4 509
ARGI4
ADDRFP4 0
INDIRI4
...
line 494
;493:
;494:void trap_BotRemoveConsoleMessage(int chatstate, int handle) {
line 495
;495:	syscall( BOTLIB_AI_REMOVE_CONSOLE_MESSAGE, chatstate, handle );
CNSTI4 510
ARGI4
ADDRFP4 0
INDIRI4
...
line 498
;497:
;498:int trap_BotNextConsoleMessage(int chatstate, void /* struct bot_consolemessage_s */ *cm) {
line 499
;499:	return syscall( BOTLIB_AI_NEXT_CONSOLE_MESSAGE, chatstate, cm );
CNSTI4 511
ARGI4
ADDRFP4 0
INDIRI4
...
;500:}
;501:
;502:int trap_BotNumConsoleMessages(int chatstate) {
line 503
;503:	return syscall( BOTLIB_AI_NUM_CONSOLE_MESSAGE, chatstate );
CNSTI4 512
ARGI4
ADDRFP4 0
INDIRI4
...
;504:}
;505:
;506:void trap_BotInitialChat(int chatstate, char *type, int mcontext, char *var0, char *var1, char *var2, char *var3, char *var4, char *var5, char *var6, char *var7 ) {
line 507
;507:	syscall( BOTLIB_AI_INITIAL_CHAT, chatstate, type, mcontext, var0, var1, var2, var3, var4, var5, var6, var7 );
CNSTI4 513
ARGI4
ADDRFP4 0
INDIRI4
...
line 510
;509:
;510:int	trap_BotNumInitialChats(int chatstate, char *type) {
line 511
;511:	return syscall( BOTLIB_AI_NUM_INITIAL_CHATS, chatstate, type );
CNSTI4 569
ARGI4
ADDRFP4 0
INDIRI4
...
;512:}
;513:
;514:int trap_BotReplyChat(int chatstate, char *message, int mcontext, int vcontext, char *var0, char *var1, char *var2, char *var3, char *var4, char *var5, char *var6, char *var7 ) {
line 515
;515:	return syscall( BOTLIB_AI_REPLY_CHAT, chatstate, message, mcontext, vcontext, var0, var1, var2, var3, var4, var5, var6, var7 );
CNSTI4 514
ARGI4
ADDRFP4 0
INDIRI4
...
;516:}
;517:
;518:int trap_BotChatLength(int chatstate) {
line 519
;519:	return syscall( BOTLIB_AI_CHAT_LENGTH, chatstate );
CNSTI4 515
ARGI4
ADDRFP4 0
INDIRI4
...
;520:}
;521:
;522:void trap_BotEnterChat(int chatstate, int client, int sendto) {
line 523
;523:	syscall( BOTLIB_AI_ENTER_CHAT, chatstate, client, sendto );
CNSTI4 516
ARGI4
ADDRFP4 0
INDIRI4
...
line 526
;525:
;526:void trap_BotGetChatMessage(int chatstate, char *buf, int size) {
line 527
;527:	syscall( BOTLIB_AI_GET_CHAT_MESSAGE, chatstate, buf, size);
CNSTI4 570
ARGI4
ADDRFP4 0
INDIRI4
...
line 530
;529:
;530:int trap_StringContains(char *str1, char *str2, int casesensitive) {
line 531
;531:	return syscall( BOTLIB_AI_STRING_CONTAINS, str1, str2, casesensitive );
CNSTI4 517
ARGI4
ADDRFP4 0
INDIRP4
...
;532:}
;533:
;534:int trap_BotFindMatch(char *str, void /* struct bot_match_s */ *match, unsigned long int context) {
line 535
;535:	return syscall( BOTLIB_AI_FIND_MATCH, str, match, context );
CNSTI4 518
ARGI4
ADDRFP4 0
INDIRP4
...
;536:}
;537:
;538:void trap_BotMatchVariable(void /* struct bot_match_s */ *match, int variable, char *buf, int size) {
line 539
;539:	syscall( BOTLIB_AI_MATCH_VARIABLE, match, variable, buf, size );
CNSTI4 519
ARGI4
ADDRFP4 0
INDIRP4
...
line 542
;541:
;542:void trap_UnifyWhiteSpaces(char *string) {
line 543
;543:	syscall( BOTLIB_AI_UNIFY_WHITE_SPACES, string );
CNSTI4 520
ARGI4
ADDRFP4 0
INDIRP4
...
line 546
;545:
;546:void trap_BotReplaceSynonyms(char *string, unsigned long int context) {
line 547
;547:	syscall( BOTLIB_AI_REPLACE_SYNONYMS, string, context );
CNSTI4 521
ARGI4
ADDRFP4 0
INDIRP4
...
line 550
;549:
;550:int trap_BotLoadChatFile(int chatstate, char *chatfile, char *chatname) {
line 551
;551:	return syscall( BOTLIB_AI_LOAD_CHAT_FILE, chatstate, chatfile, chatname );
CNSTI4 522
ARGI4
ADDRFP4 0
INDIRI4
...
;552:}
;553:
;554:void trap_BotSetChatGender(int chatstate, int gender) {
line 555
;555:	syscall( BOTLIB_AI_SET_CHAT_GENDER, chatstate, gender );
CNSTI4 523
ARGI4
ADDRFP4 0
INDIRI4
...
line 558
;557:
;558:void trap_BotSetChatName(int chatstate, char *name, int client) {
line 559
;559:	syscall( BOTLIB_AI_SET_CHAT_NAME, chatstate, name, client );
CNSTI4 524
ARGI4
ADDRFP4 0
INDIRI4
...
line 562
;561:
;562:void trap_BotResetGoalState(int goalstate) {
line 563
;563:	syscall( BOTLIB_AI_RESET_GOAL_STATE, goalstate );
CNSTI4 525
ARGI4
ADDRFP4 0
INDIRI4
...
line 566
;565:
;566:void trap_BotResetAvoidGoals(int goalstate) {
line 567
;567:	syscall( BOTLIB_AI_RESET_AVOID_GOALS, goalstate );
CNSTI4 526
ARGI4
ADDRFP4 0
INDIRI4
...
line 570
;569:
;570:void trap_BotRemoveFromAvoidGoals(int goalstate, int number) {
line 571
;571:	syscall( BOTLIB_AI_REMOVE_FROM_AVOID_GOALS, goalstate, number);
CNSTI4 571
ARGI4
ADDRFP4 0
INDIRI4
...
line 574
;573:
;574:void trap_BotPushGoal(int goalstate, void /* struct bot_goal_s */ *goal) {
line 575
;575:	syscall( BOTLIB_AI_PUSH_GOAL, goalstate, goal );
CNSTI4 527
ARGI4
ADDRFP4 0
INDIRI4
...
line 578
;577:
;578:void trap_BotPopGoal(int goalstate) {
line 579
;579:	syscall( BOTLIB_AI_POP_GOAL, goalstate );
CNSTI4 528
ARGI4
ADDRFP4 0
INDIRI4
...
line 582
;581:
;582:void trap_BotEmptyGoalStack(int goalstate) {
line 583
;583:	syscall( BOTLIB_AI_EMPTY_GOAL_STACK, goalstate );
CNSTI4 529
ARGI4
ADDRFP4 0
INDIRI4
...
line 586
;585:
;586:void trap_BotDumpAvoidGoals(int goalstate) {
line 587
;587:	syscall( BOTLIB_AI_DUMP_AVOID_GOALS, goalstate );
CNSTI4 530
ARGI4
ADDRFP4 0
INDIRI4
...
line 590
;589:
;590:void trap_BotDumpGoalStack(int goalstate) {
line 591
;591:	syscall( BOTLIB_AI_DUMP_GOAL_STACK, goalstate );
CNSTI4 531
ARGI4
ADDRFP4 0
INDIRI4
...
line 594
;593:
;594:void trap_BotGoalName(int number, char *name, int size) {
line 595
;595:	syscall( BOTLIB_AI_GOAL_NAME, number, name, size );
CNSTI4 532
ARGI4
ADDRFP4 0
INDIRI4
...
line 598
;597:
;598:int trap_BotGetTopGoal(int goalstate, void /* struct bot_goal_s */ *goal) {
line 599
;599:	return syscall( BOTLIB_AI_GET_TOP_GOAL, goalstate, goal );
CNSTI4 533
ARGI4
ADDRFP4 0
INDIRI4
...
;600:}
;601:
;602:int trap_BotGetSecondGoal(int goalstate, void /* struct bot_goal_s */ *goal) {
line 603
;603:	return syscall( BOTLIB_AI_GET_SECOND_GOAL, goalstate, goal );
CNSTI4 534
ARGI4
ADDRFP4 0
INDIRI4
...
;604:}
;605:
;606:int trap_BotChooseLTGItem(int goalstate, vec3_t origin, int *inventory, int travelflags) {
line 607
;607:	return syscall( BOTLIB_AI_CHOOSE_LTG_ITEM, goalstate, origin, inventory, travelflags );
CNSTI4 535
ARGI4
ADDRFP4 0
INDIRI4
...
;608:}
;609:
;610:int trap_BotChooseNBGItem(int goalstate, vec3_t origin, int *inventory, int travelflags, void /* struct bot_goal_s */ *ltg, float maxtime) {
line 611
;611:	return syscall( BOTLIB_AI_CHOOSE_NBG_ITEM, goalstate, origin, inventory, travelflags, ltg, PASSFLOAT(maxtime) );
ADDRFP4 20
INDIRF4
ARGF4
ADDRLP4 0
...
;612:}
;613:
;614:int trap_BotTouchingGoal(vec3_t origin, void /* struct bot_goal_s */ *goal) {
line 615
;615:	return syscall( BOTLIB_AI_TOUCHING_GOAL, origin, goal );
CNSTI4 537
ARGI4
ADDRFP4 0
INDIRP4
...
;616:}
;617:
;618:int trap_BotItemGoalInVisButNotVisible(int viewer, vec3_t eye, vec3_t viewangles, void /* struct bot_goal_s */ *goal) {
line 619
;619:	return syscall( BOTLIB_AI_ITEM_GOAL_IN_VIS_BUT_NOT_VISIBLE, viewer, eye, viewangles, goal );
CNSTI4 538
ARGI4
ADDRFP4 0
INDIRI4
...
;620:}
;621:
;622:int trap_BotGetLevelItemGoal(int index, char *classname, void /* struct bot_goal_s */ *goal) {
line 623
;623:	return syscall( BOTLIB_AI_GET_LEVEL_ITEM_GOAL, index, classname, goal );
CNSTI4 539
ARGI4
ADDRFP4 0
INDIRI4
...
;624:}
;625:
;626:int trap_BotGetNextCampSpotGoal(int num, void /* struct bot_goal_s */ *goal) {
line 627
;627:	return syscall( BOTLIB_AI_GET_NEXT_CAMP_SPOT_GOAL, num, goal );
CNSTI4 567
ARGI4
ADDRFP4 0
INDIRI4
...
;628:}
;629:
;630:int trap_BotGetMapLocationGoal(char *name, void /* struct bot_goal_s */ *goal) {
line 631
;631:	return syscall( BOTLIB_AI_GET_MAP_LOCATION_GOAL, name, goal );
CNSTI4 568
ARGI4
ADDRFP4 0
INDIRP4
...
;632:}
;633:
;634:float trap_BotAvoidGoalTime(int goalstate, int number) {
line 636
;635:	int temp;
;636:	temp = syscall( BOTLIB_AI_AVOID_GOAL_TIME, goalstate, number );
CNSTI4 540
ARGI4
ADDRFP4 0
INDIRI4
...
;638:}
;639:
;640:void trap_BotSetAvoidGoalTime(int goalstate, int number, float avoidtime) {
line 641
;641:	syscall( BOTLIB_AI_SET_AVOID_GOAL_TIME, goalstate, number, PASSFLOAT(avoidtime));
ADDRFP4 8
INDIRF4
ARGF4
ADDRLP4 0
...
line 644
;643:
;644:void trap_BotInitLevelItems(void) {
line 645
;645:	syscall( BOTLIB_AI_INIT_LEVEL_ITEMS );
CNSTI4 541
ARGI4
ADDRGP4 syscall
INDIRP4
...
line 648
;647:
;648:void trap_BotUpdateEntityItems(void) {
line 649
;649:	syscall( BOTLIB_AI_UPDATE_ENTITY_ITEMS );
CNSTI4 542
ARGI4
ADDRGP4 syscall
INDIRP4
...
line 652
;651:
;652:int trap_BotLoadItemWeights(int goalstate, char *filename) {
line 653
;653:	return syscall( BOTLIB_AI_LOAD_ITEM_WEIGHTS, goalstate, filename );
CNSTI4 543
ARGI4
ADDRFP4 0
INDIRI4
...
;654:}
;655:
;656:void trap_BotFreeItemWeights(int goalstate) {
line 657
;657:	syscall( BOTLIB_AI_FREE_ITEM_WEIGHTS, goalstate );
CNSTI4 544
ARGI4
ADDRFP4 0
INDIRI4
...
line 660
;659:
;660:void trap_BotInterbreedGoalFuzzyLogic(int parent1, int parent2, int child) {
line 661
;661:	syscall( BOTLIB_AI_INTERBREED_GOAL_FUZZY_LOGIC, parent1, parent2, child );
CNSTI4 565
ARGI4
ADDRFP4 0
INDIRI4
...
line 664
;663:
;664:void trap_BotSaveGoalFuzzyLogic(int goalstate, char *filename) {
line 665
;665:	syscall( BOTLIB_AI_SAVE_GOAL_FUZZY_LOGIC, goalstate, filename );
CNSTI4 545
ARGI4
ADDRFP4 0
INDIRI4
...
line 668
;667:
;668:void trap_BotMutateGoalFuzzyLogic(int goalstate, float range) {
line 669
;669:	syscall( BOTLIB_AI_MUTATE_GOAL_FUZZY_LOGIC, goalstate, range );
CNSTI4 566
ARGI4
ADDRFP4 0
INDIRI4
...
line 672
;671:
;672:int trap_BotAllocGoalState(int state) {
line 673
;673:	return syscall( BOTLIB_AI_ALLOC_GOAL_STATE, state );
CNSTI4 546
ARGI4
ADDRFP4 0
INDIRI4
...
;674:}
;675:
;676:void trap_BotFreeGoalState(int handle) {
line 677
;677:	syscall( BOTLIB_AI_FREE_GOAL_STATE, handle );
CNSTI4 547
ARGI4
ADDRFP4 0
INDIRI4
...
line 680
;679:
;680:void trap_BotResetMoveState(int movestate) {
line 681
;681:	syscall( BOTLIB_AI_RESET_MOVE_STATE, movestate );
CNSTI4 548
ARGI4
ADDRFP4 0
INDIRI4
...
line 684
;683:
;684:void trap_BotAddAvoidSpot(int movestate, vec3_t origin, float radius, int type) {
line 685
;685:	syscall( BOTLIB_AI_ADD_AVOID_SPOT, movestate, origin, PASSFLOAT(radius), type);
ADDRFP4 8
INDIRF4
ARGF4
ADDRLP4 0
...
line 688
;687:
;688:void trap_BotMoveToGoal(void /* struct bot_moveresult_s */ *result, int movestate, void /* struct bot_goal_s */ *goal, int travelflags) {
line 689
;689:	syscall( BOTLIB_AI_MOVE_TO_GOAL, result, movestate, goal, travelflags );
CNSTI4 549
ARGI4
ADDRFP4 0
INDIRP4
...
line 692
;691:
;692:int trap_BotMoveInDirection(int movestate, vec3_t dir, float speed, int type) {
line 693
;693:	return syscall( BOTLIB_AI_MOVE_IN_DIRECTION, movestate, dir, PASSFLOAT(speed), type );
ADDRFP4 8
INDIRF4
ARGF4
ADDRLP4 0
...
;694:}
;695:
;696:void trap_BotResetAvoidReach(int movestate) {
line 697
;697:	syscall( BOTLIB_AI_RESET_AVOID_REACH, movestate );
CNSTI4 551
ARGI4
ADDRFP4 0
INDIRI4
...
line 700
;699:
;700:void trap_BotResetLastAvoidReach(int movestate) {
line 701
;701:	syscall( BOTLIB_AI_RESET_LAST_AVOID_REACH,movestate  );
CNSTI4 552
ARGI4
ADDRFP4 0
INDIRI4
...
line 704
;703:
;704:int trap_BotReachabilityArea(vec3_t origin, int testground) {
line 705
;705:	return syscall( BOTLIB_AI_REACHABILITY_AREA, origin, testground );
CNSTI4 553
ARGI4
ADDRFP4 0
INDIRP4
...
;706:}
;707:
;708:int trap_BotMovementViewTarget(int movestate, void /* struct bot_goal_s */ *goal, int travelflags, float lookahead, vec3_t target) {
line 709
;709:	return syscall( BOTLIB_AI_MOVEMENT_VIEW_TARGET, movestate, goal, travelflags, PASSFLOAT(lookahead), target );
ADDRFP4 12
INDIRF4
ARGF4
ADDRLP4 0
...
;710:}
;711:
;712:int trap_BotPredictVisiblePosition(vec3_t origin, int areanum, void /* struct bot_goal_s */ *goal, int travelflags, vec3_t target) {
line 713
;713:	return syscall( BOTLIB_AI_PREDICT_VISIBLE_POSITION, origin, areanum, goal, travelflags, target );
CNSTI4 572
ARGI4
ADDRFP4 0
INDIRP4
...
;714:}
;715:
;716:int trap_BotAllocMoveState(void) {
line 717
;717:	return syscall( BOTLIB_AI_ALLOC_MOVE_STATE );
CNSTI4 555
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;718:}
;719:
;720:void trap_BotFreeMoveState(int handle) {
line 721
;721:	syscall( BOTLIB_AI_FREE_MOVE_STATE, handle );
CNSTI4 556
ARGI4
ADDRFP4 0
INDIRI4
...
line 724
;723:
;724:void trap_BotInitMoveState(int handle, void /* struct bot_initmove_s */ *initmove) {
line 725
;725:	syscall( BOTLIB_AI_INIT_MOVE_STATE, handle, initmove );
CNSTI4 557
ARGI4
ADDRFP4 0
INDIRI4
...
line 728
;727:
;728:int trap_BotChooseBestFightWeapon(int weaponstate, int *inventory) {
line 729
;729:	return syscall( BOTLIB_AI_CHOOSE_BEST_FIGHT_WEAPON, weaponstate, inventory );
CNSTI4 558
ARGI4
ADDRFP4 0
INDIRI4
...
;730:}
;731:
;732:void trap_BotGetWeaponInfo(int weaponstate, int weapon, void /* struct weaponinfo_s */ *weaponinfo) {
line 733
;733:	syscall( BOTLIB_AI_GET_WEAPON_INFO, weaponstate, weapon, weaponinfo );
CNSTI4 559
ARGI4
ADDRFP4 0
INDIRI4
...
line 736
;735:
;736:int trap_BotLoadWeaponWeights(int weaponstate, char *filename) {
line 737
;737:	return syscall( BOTLIB_AI_LOAD_WEAPON_WEIGHTS, weaponstate, filename );
CNSTI4 560
ARGI4
ADDRFP4 0
INDIRI4
...
;738:}
;739:
;740:int trap_BotAllocWeaponState(void) {
line 741
;741:	return syscall( BOTLIB_AI_ALLOC_WEAPON_STATE );
CNSTI4 561
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;742:}
;743:
;744:void trap_BotFreeWeaponState(int weaponstate) {
line 745
;745:	syscall( BOTLIB_AI_FREE_WEAPON_STATE, weaponstate );
CNSTI4 562
ARGI4
ADDRFP4 0
INDIRI4
...
line 748
;747:
;748:void trap_BotResetWeaponState(int weaponstate) {
line 749
;749:	syscall( BOTLIB_AI_RESET_WEAPON_STATE, weaponstate );
CNSTI4 563
ARGI4
ADDRFP4 0
INDIRI4
...
line 752
;751:
;752:int trap_GeneticParentsAndChildSelection(int numranks, float *ranks, int *parent1, int *parent2, int *child) {
line 753
;753:	return syscall( BOTLIB_AI_GENETIC_PARENTS_AND_CHILD_SELECTION, numranks, ranks, parent1, parent2, child );
CNSTI4 564
ARGI4
ADDRFP4 0
INDIRI4
...
;754:}
;755:
;756:int trap_PC_LoadSource( const char *filename ) {
line 757
;757:	return syscall( BOTLIB_PC_LOAD_SOURCE, filename );
CNSTI4 578
ARGI4
ADDRFP4 0
INDIRP4
...
;758:}
;759:
;760:int trap_PC_FreeSource( int handle ) {
line 761
;761:	return syscall( BOTLIB_PC_FREE_SOURCE, handle );
CNSTI4 579
ARGI4
ADDRFP4 0
INDIRI4
...
;762:}
;763:
;764:int trap_PC_ReadToken( int handle, pc_token_t *pc_token ) {
line 765
;765:	return syscall( BOTLIB_PC_READ_TOKEN, handle, pc_token );
CNSTI4 580
ARGI4
ADDRFP4 0
INDIRI4
...
;766:}
;767:
;768:int trap_PC_SourceFileAndLine( int handle, char *filename, int *line ) {
line 769
;769:	return syscall( BOTLIB_PC_SOURCE_FILE_AND_LINE, handle, filename, line );
CNSTI4 581
ARGI4
ADDRFP4 0
INDIRI4
