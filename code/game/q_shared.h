...
#pragma warning(disable : 4389)		// warning from original id source release
#pragma warning(disable : 4133)		// warning from original id source release
#endif
...
typedef enum {
	...
	TR_GRAVITY,
	TR_HALFGRAVITY				// JT092905 - new gravity value for new grenade launcher
} trType_t;
