...
;1821:		// QUAKE 3 BUG FIX - start
;1822:		if ( cgs.clientinfo[ cent->currentState.clientNum ].team == TEAM_RED ) {
CNSTI4 1708
ADDRFP4 0
INDIRP4
CNSTI4 168
...
NEI4 $844
line 1823
;1823:			trap_R_AddLightToScene( cent->lerpOrigin, 200 + (rand()&31), 1, 0.2f, 0.2f );
ADDRLP4 8
ADDRGP4 rand
CALLI4
ASGNI4
...
LABELV $844
line 1825
;1825:			trap_R_AddLightToScene( cent->lerpOrigin, 200 + (rand()&31), 0.2f, 0.2f, 1 );
ADDRLP4 8
ADDRGP4 rand
CALLI4
ASGNI4
...
LABELV $845
line 1828
;1827:		// QUAKE 3 BUG FIX - end
;1828:	}
LABELV $842
line 1831
;1829:
;1830:	// flight plays a looped sound
;1831:	if ( powerups & ( 1 << PW_FLIGHT ) ) {
ADDRLP4 0
INDIRI4
CNSTI4 64
BANDI4
...
EQI4 $848
line 1832
;1832:		trap_S_AddLoopingSound( cent->currentState.number, cent->lerpOrigin, vec3_origin, cgs.media.flightSound );
ADDRLP4 8
ADDRFP4 0
INDIRP4
ASGNP4
...
line 1835
;1834:
;1835:	ci = &cgs.clientinfo[ cent->currentState.clientNum ];
ADDRLP4 4
CNSTI4 1708
ADDRFP4 0
INDIRP4
...
EQI4 $855
line 1839
;1839:			CG_PlayerFlag( cent, cgs.media.redFlagFlapSkin, torso );
ADDRFP4 0
INDIRP4
ARGP4
...
;1841:		else {
line 1842
;1842:			CG_TrailItem( cent, cgs.media.redFlagModel );
ADDRFP4 0
INDIRP4
ARGP4
...
LABELV $856
line 1844
;1844:		trap_R_AddLightToScene( cent->lerpOrigin, 200 + (rand()&31), 1.0, 0.2f, 0.2f );
ADDRLP4 8
ADDRGP4 rand
CALLI4
ASGNI4
...
;1846:
;1847:	// blueflag
;1848:	if ( powerups & ( 1 << PW_BLUEFLAG ) ) {
ADDRLP4 0
INDIRI4
CNSTI4 256
BANDI4
...
EQI4 $863
line 1850
;1850:			CG_PlayerFlag( cent, cgs.media.blueFlagFlapSkin, torso );
ADDRFP4 0
INDIRP4
ARGP4
...
;1852:		else {
line 1853
;1853:			CG_TrailItem( cent, cgs.media.blueFlagModel );
ADDRFP4 0
INDIRP4
ARGP4
...
LABELV $864
line 1855
;1855:		trap_R_AddLightToScene( cent->lerpOrigin, 200 + (rand()&31), 0.2f, 0.2f, 1.0 );
ADDRLP4 8
ADDRGP4 rand
CALLI4
ASGNI4
...
;1857:
;1858:	// neutralflag
;1859:	if ( powerups & ( 1 << PW_NEUTRALFLAG ) ) {
ADDRLP4 0
INDIRI4
CNSTI4 512
BANDI4
...
EQI4 $871
line 1861
;1861:			CG_PlayerFlag( cent, cgs.media.neutralFlagFlapSkin, torso );
ADDRFP4 0
INDIRP4
ARGP4
...
;1863:		else {
line 1864
;1864:			CG_TrailItem( cent, cgs.media.neutralFlagModel );
ADDRFP4 0
INDIRP4
ARGP4
...
LABELV $872
line 1866
;1866:		trap_R_AddLightToScene( cent->lerpOrigin, 200 + (rand()&31), 1.0, 1.0, 1.0 );
ADDRLP4 8
ADDRGP4 rand
CALLI4
ASGNI4
...
line 1870
;1868:
;1869:	// haste leaves smoke trails
;1870:	if ( powerups & ( 1 << PW_HASTE ) ) {
ADDRLP4 0
INDIRI4
CNSTI4 8
BANDI4
...
;1876:/*
;1877:===============
;1878:CG_PlayerFloatSprite
;1879:
;1880:Float a sprite over the player's head
;1881:===============
;1882:*/
;1883:static void CG_PlayerFloatSprite( centity_t *cent, qhandle_t shader ) {
line 1887
;1884:	int				rf;
;1885:	refEntity_t		ent;
;1886:
;1887:	if ( cent->currentState.number == cg.snap->ps.clientNum && !cg.renderingThirdPerson ) {
ADDRFP4 0
INDIRP4
INDIRI4
ADDRGP4 cg+36
...
NEI4 $880
line 1888
;1888:		rf = RF_THIRD_PERSON;		// only show in mirrors
ADDRLP4 140
CNSTI4 2
ASGNI4
line 1889
...
pop
line 1894
;1894:	VectorCopy( cent->lerpOrigin, ent.origin );
ADDRLP4 0+68
ADDRFP4 0
INDIRP4
CNSTI4 704
...
ASGNF4
line 1896
;1896:	ent.reType = RT_SPRITE;
ADDRLP4 0
CNSTI4 2
ASGNI4
line 1897
;1897:	ent.customShader = shader;
ADDRLP4 0+112
ADDRFP4 4
INDIRI4
ASGNI4
...
ASGNF4
line 1899
;1899:	ent.renderfx = rf;
ADDRLP4 0+4
ADDRLP4 140
INDIRI4
ASGNI4
line 1900
;1900:	ent.shaderRGBA[0] = 255;
ADDRLP4 0+116
CNSTU1 255
ASGNU1
line 1901
;1901:	ent.shaderRGBA[1] = 255;
ADDRLP4 0+116+1
CNSTU1 255
ASGNU1
line 1902
;1902:	ent.shaderRGBA[2] = 255;
ADDRLP4 0+116+2
CNSTU1 255
ASGNU1
line 1903
;1903:	ent.shaderRGBA[3] = 255;
ADDRLP4 0+116+3
CNSTU1 255
ASGNU1
line 1904
;1904:	trap_R_AddRefEntityToScene( &ent );
ADDRLP4 0
ARGP4
ADDRGP4 trap_R_AddRefEntityToScene
CALLV
...
;1909:/*
;1910:===============
;1911:CG_PlayerSprites
;1912:
;1913:Float sprites over the player's head
;1914:===============
;1915:*/
;1916:static void CG_PlayerSprites( centity_t *cent ) {
line 1919
;1917:	int		team;
;1918:
;1919:	if ( cent->currentState.eFlags & EF_CONNECTION ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $898
line 1920
;1920:		CG_PlayerFloatSprite( cent, cgs.media.connectionShader );
ADDRFP4 0
INDIRP4
ARGP4
...
;1922:	}
;1923:
;1924:	if ( cent->currentState.eFlags & EF_TALK ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $902
line 1925
;1925:		CG_PlayerFloatSprite( cent, cgs.media.balloonShader );
ADDRFP4 0
INDIRP4
ARGP4
...
;1927:	}
;1928:
;1929:	if ( cent->currentState.eFlags & EF_AWARD_IMPRESSIVE ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $906
line 1930
;1930:		CG_PlayerFloatSprite( cent, cgs.media.medalImpressive );
ADDRFP4 0
INDIRP4
ARGP4
...
;1932:	}
;1933:
;1934:	if ( cent->currentState.eFlags & EF_AWARD_EXCELLENT ) {
ADDRLP4 4
CNSTI4 8
ASGNI4
ADDRFP4 0
...
EQI4 $910
line 1935
;1935:		CG_PlayerFloatSprite( cent, cgs.media.medalExcellent );
ADDRFP4 0
INDIRP4
ARGP4
...
;1937:	}
;1938:
;1939:	if ( cent->currentState.eFlags & EF_AWARD_GAUNTLET ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $914
line 1940
;1940:		CG_PlayerFloatSprite( cent, cgs.media.medalGauntlet );
ADDRFP4 0
INDIRP4
ARGP4
...
;1942:	}
;1943:
;1944:	if ( cent->currentState.eFlags & EF_AWARD_DEFEND ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $918
line 1945
;1945:		CG_PlayerFloatSprite( cent, cgs.media.medalDefend );
ADDRFP4 0
INDIRP4
ARGP4
...
;1947:	}
;1948:
;1949:	if ( cent->currentState.eFlags & EF_AWARD_ASSIST ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $922
line 1950
;1950:		CG_PlayerFloatSprite( cent, cgs.media.medalAssist );
ADDRFP4 0
INDIRP4
ARGP4
...
;1952:	}
;1953:
;1954:	if ( cent->currentState.eFlags & EF_AWARD_CAP ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $926
line 1955
;1955:		CG_PlayerFloatSprite( cent, cgs.media.medalCapture );
ADDRFP4 0
INDIRP4
ARGP4
...
;1957:	}
;1958:
;1959:	team = cgs.clientinfo[ cent->currentState.clientNum ].team;
ADDRLP4 0
CNSTI4 1708
ADDRFP4 0
INDIRP4
...
ASGNI4
line 1960
;1960:	if ( !(cent->currentState.eFlags & EF_DEAD) && 
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
LTI4 $932
line 1962
;1961:		cg.snap->ps.persistant[PERS_TEAM] == team &&
;1962:		cgs.gametype >= GT_TEAM) {
line 1963
;1963:		if (cg_drawFriend.integer) {
ADDRGP4 cg_drawFriend+12
INDIRI4
CNSTI4 0
EQI4 $897
line 1964
;1964:			CG_PlayerFloatSprite( cent, cgs.media.friendShader );
ADDRFP4 0
INDIRP4
ARGP4
...
;1970:/*
;1971:===============
;1972:CG_PlayerShadow
;1973:
;1974:Returns the Z component of the surface being shadowed
;1975:
;1976:  should it return a full plane instead of a Z?
;1977:===============
;1978:*/
;1979:#define	SHADOW_DISTANCE		128
;1980:static qboolean CG_PlayerShadow( centity_t *cent, float *shadowPlane ) {
line 1981
;1981:	vec3_t		end, mins = {-15, -15, 0}, maxs = {15, 15, 2};
ADDRLP4 72
ADDRGP4 $942
INDIRB
ASGNB 12
...
;1989:	}
;1990:
;1991:	// no shadows when invisible
;1992:	if ( cent->currentState.powerups & ( 1 << PW_INVIS ) ) {
ADDRFP4 0
INDIRP4
CNSTI4 188
ADDP4
...
;1994:	}
;1995:
;1996:	// send a trace down from the player to the ground
;1997:	VectorCopy( cent->lerpOrigin, end );
ADDRLP4 60
ADDRFP4 0
INDIRP4
CNSTI4 704
...
line 2000
;1999:
;2000:	trap_CM_BoxTrace( &trace, cent->lerpOrigin, end, mins, maxs, 0, MASK_PLAYERSOLID );
ADDRLP4 0
ARGP4
ADDRFP4 0
INDIRP4
...
line 2003
;2001:
;2002:	// no shadow if too high
;2003:	if ( trace.fraction == 1.0 || trace.startsolid || trace.allsolid ) {
ADDRLP4 0+8
INDIRF4
CNSTF4 1065353216
EQF4 $955
...
;2005:	}
;2006:
;2007:	*shadowPlane = trace.endpos[2] + 1;
ADDRFP4 4
INDIRP4
ADDRLP4 0+12+8
INDIRF4
...
line 2009
;2008:
;2009:	if ( cg_shadows.integer != 1 ) {	// no mark for stencil or projection shadows
ADDRGP4 cg_shadows+12
INDIRI4
CNSTI4 1
EQI4 $958
...
;2011:	}
;2012:
;2013:	// fade the shadow out with height
;2014:	alpha = 1.0 - trace.fraction;
ADDRLP4 56
CNSTF4 1065353216
ADDRLP4 0+8
INDIRF4
...
line 2021
;2015:
;2016:	// bk0101022 - hack / FPE - bogus planes?
;2017:	//assert( DotProduct( trace.plane.normal, trace.plane.normal ) != 0.0f ) 
;2018:
;2019:	// add the mark as a temporary, so it goes directly to the renderer
;2020:	// without taking a spot in the cg_marks array
;2021:	CG_ImpactMark( cgs.media.shadowMarkShader, trace.endpos, trace.plane.normal, 
...
pop
line 2024
;2022:		cent->pe.legs.yawAngle, alpha,alpha,alpha,1, qfalse, 24, qtrue );
;2023:
;2024:	return qtrue;
CNSTI4 1
RETI4
...
;2028:/*
;2029:===============
;2030:CG_PlayerSplash
;2031:
;2032:Draw a mark at the water surface
;2033:===============
;2034:*/
;2035:static void CG_PlayerSplash( centity_t *cent ) {
line 2041
;2036:	vec3_t		start, end;
;2037:	trace_t		trace;
;2038:	int			contents;
;2039:	polyVert_t	verts[4];
;2040:
;2041:	if ( !cg_shadows.integer ) {
ADDRGP4 cg_shadows+12
INDIRI4
CNSTI4 0
NEI4 $967
...
;2043:	}
;2044:
;2045:	VectorCopy( cent->lerpOrigin, end );
ADDRLP4 164
ADDRFP4 0
INDIRP4
CNSTI4 704
...
line 2050
;2047:
;2048:	// if the feet aren't in liquid, don't make a mark
;2049:	// this won't handle moving water brushes, but they wouldn't draw right anyway...
;2050:	contents = trap_CM_PointContents( end, 0 );
ADDRLP4 164
ARGP4
CNSTI4 0
ARGI4
...
ASGNI4
line 2051
;2051:	if ( !( contents & ( CONTENTS_WATER | CONTENTS_SLIME | CONTENTS_LAVA ) ) ) {
ADDRLP4 176
INDIRI4
CNSTI4 56
BANDI4
...
;2053:	}
;2054:
;2055:	VectorCopy( cent->lerpOrigin, start );
ADDRLP4 152
ADDRFP4 0
INDIRP4
CNSTI4 704
...
line 2059
;2057:
;2058:	// if the head isn't out of liquid, don't make a mark
;2059:	contents = trap_CM_PointContents( start, 0 );
ADDRLP4 152
ARGP4
CNSTI4 0
ARGI4
...
ASGNI4
line 2060
;2060:	if ( contents & ( CONTENTS_SOLID | CONTENTS_WATER | CONTENTS_SLIME | CONTENTS_LAVA ) ) {
ADDRLP4 176
INDIRI4
CNSTI4 57
BANDI4
...
;2062:	}
;2063:
;2064:	// trace down to find the surface
;2065:	trap_CM_BoxTrace( &trace, start, end, NULL, NULL, 0, ( CONTENTS_WATER | CONTENTS_SLIME | CONTENTS_LAVA ) );
ADDRLP4 96
ARGP4
ADDRLP4 152
ARGP4
...
;2069:	}
;2070:
;2071:	// create a mark polygon
;2072:	VectorCopy( trace.endpos, verts[0].xyz );
ADDRLP4 0
ADDRLP4 96+12
INDIRB
ASGNB 12
line 2073
;2073:	verts[0].xyz[0] -= 32;
ADDRLP4 0
ADDRLP4 0
INDIRF4
CNSTF4 1107296256
...
ASGNF4
line 2077
;2077:	verts[0].modulate[0] = 255;
ADDRLP4 0+20
CNSTU1 255
ASGNU1
line 2078
;2078:	verts[0].modulate[1] = 255;
ADDRLP4 0+20+1
CNSTU1 255
ASGNU1
line 2079
;2079:	verts[0].modulate[2] = 255;
ADDRLP4 0+20+2
CNSTU1 255
ASGNU1
line 2080
;2080:	verts[0].modulate[3] = 255;
ADDRLP4 0+20+3
CNSTU1 255
ASGNU1
line 2082
;2081:
;2082:	VectorCopy( trace.endpos, verts[1].xyz );
ADDRLP4 0+24
ADDRLP4 96+12
INDIRB
ASGNB 12
line 2083
;2083:	verts[1].xyz[0] -= 32;
ADDRLP4 0+24
ADDRLP4 0+24
INDIRF4
CNSTF4 1107296256
...
ASGNF4
line 2087
;2087:	verts[1].modulate[0] = 255;
ADDRLP4 0+24+20
CNSTU1 255
ASGNU1
line 2088
;2088:	verts[1].modulate[1] = 255;
ADDRLP4 0+24+20+1
CNSTU1 255
ASGNU1
line 2089
;2089:	verts[1].modulate[2] = 255;
ADDRLP4 0+24+20+2
CNSTU1 255
ASGNU1
line 2090
;2090:	verts[1].modulate[3] = 255;
ADDRLP4 0+24+20+3
CNSTU1 255
ASGNU1
line 2092
;2091:
;2092:	VectorCopy( trace.endpos, verts[2].xyz );
ADDRLP4 0+48
ADDRLP4 96+12
INDIRB
ASGNB 12
line 2093
;2093:	verts[2].xyz[0] += 32;
ADDRLP4 0+48
ADDRLP4 0+48
INDIRF4
CNSTF4 1107296256
...
ASGNF4
line 2097
;2097:	verts[2].modulate[0] = 255;
ADDRLP4 0+48+20
CNSTU1 255
ASGNU1
line 2098
;2098:	verts[2].modulate[1] = 255;
ADDRLP4 0+48+20+1
CNSTU1 255
ASGNU1
line 2099
;2099:	verts[2].modulate[2] = 255;
ADDRLP4 0+48+20+2
CNSTU1 255
ASGNU1
line 2100
;2100:	verts[2].modulate[3] = 255;
ADDRLP4 0+48+20+3
CNSTU1 255
ASGNU1
line 2102
;2101:
;2102:	VectorCopy( trace.endpos, verts[3].xyz );
ADDRLP4 0+72
ADDRLP4 96+12
INDIRB
ASGNB 12
line 2103
;2103:	verts[3].xyz[0] += 32;
ADDRLP4 0+72
ADDRLP4 0+72
INDIRF4
CNSTF4 1107296256
...
ASGNF4
line 2107
;2107:	verts[3].modulate[0] = 255;
ADDRLP4 0+72+20
CNSTU1 255
ASGNU1
line 2108
;2108:	verts[3].modulate[1] = 255;
ADDRLP4 0+72+20+1
CNSTU1 255
ASGNU1
line 2109
;2109:	verts[3].modulate[2] = 255;
ADDRLP4 0+72+20+2
CNSTU1 255
ASGNU1
line 2110
;2110:	verts[3].modulate[3] = 255;
ADDRLP4 0+72+20+3
CNSTU1 255
ASGNU1
line 2112
;2111:
;2112:	trap_R_AddPolyToScene( cgs.media.wakeMarkShader, 4, verts );
...
;2117:/*
;2118:===============
;2119:CG_AddRefEntityWithPowerups
;2120:
;2121:Adds a piece with modifications or duplications for powerups
;2122:Also called by CG_Missile for quad rockets, but nobody can tell...
;2123:===============
;2124:*/
;2125:void CG_AddRefEntityWithPowerups( refEntity_t *ent, entityState_t *state, int team ) {
line 2127
;2126:
;2127:	if ( state->powerups & ( 1 << PW_INVIS ) ) {
ADDRFP4 4
INDIRP4
CNSTI4 188
ADDP4
...
EQI4 $1057
line 2128
;2128:		ent->customShader = cgs.media.invisShader;
ADDRFP4 0
INDIRP4
CNSTI4 112
ADDP4
...
ASGNI4
line 2129
;2129:		trap_R_AddRefEntityToScene( ent );
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 trap_R_AddRefEntityToScene
...
line 2140
;2131:		/*
;2132:		if ( state->eFlags & EF_KAMIKAZE ) {
;2133:			if (team == TEAM_BLUE)
;2134:				ent->customShader = cgs.media.blueKamikazeShader;
;2135:			else
;2136:				ent->customShader = cgs.media.redKamikazeShader;
;2137:			trap_R_AddRefEntityToScene( ent );
;2138:		}
;2139:		else {*/
;2140:			trap_R_AddRefEntityToScene( ent );
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 trap_R_AddRefEntityToScene
...
;2141:		//}
;2142:
;2143:		if ( state->powerups & ( 1 << PW_QUAD ) )
ADDRFP4 4
INDIRP4
CNSTI4 188
ADDP4
...
;2144:		{
line 2145
;2145:			if (team == TEAM_RED)
ADDRFP4 8
INDIRI4
CNSTI4 1
NEI4 $1063
line 2146
;2146:				ent->customShader = cgs.media.redQuadShader;
ADDRFP4 0
INDIRP4
CNSTI4 112
ADDP4
...
line 2148
;2147:			else
;2148:				ent->customShader = cgs.media.quadShader;
ADDRFP4 0
INDIRP4
CNSTI4 112
ADDP4
...
LABELV $1064
line 2149
;2149:			trap_R_AddRefEntityToScene( ent );
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 trap_R_AddRefEntityToScene
...
LABELV $1061
line 2151
;2151:		if ( state->powerups & ( 1 << PW_REGEN ) ) {
ADDRFP4 4
INDIRP4
CNSTI4 188
ADDP4
...
NEI4 $1071
line 2153
;2153:				ent->customShader = cgs.media.regenShader;
ADDRFP4 0
INDIRP4
CNSTI4 112
ADDP4
...
LABELV $1069
line 2157
;2157:		if ( state->powerups & ( 1 << PW_BATTLESUIT ) ) {
ADDRFP4 4
INDIRP4
CNSTI4 188
ADDP4
...
EQI4 $1076
line 2158
;2158:			ent->customShader = cgs.media.battleSuitShader;
ADDRFP4 0
INDIRP4
CNSTI4 112
ADDP4
...
ASGNI4
line 2159
;2159:			trap_R_AddRefEntityToScene( ent );
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 trap_R_AddRefEntityToScene
...
;2167:=================
;2168:*/
;2169:int CG_LightVerts( vec3_t normal, int numVerts, polyVert_t *verts )
;2170:{
line 2177
;2171:	int				i, j;
;2172:	float			incoming;
;2173:	vec3_t			ambientLight;
;2174:	vec3_t			lightDir;
;2175:	vec3_t			directedLight;
;2176:
;2177:	trap_R_LightForPoint( verts[0].xyz, ambientLight, directedLight, lightDir );
ADDRFP4 8
INDIRP4
ARGP4
ADDRLP4 12
...
LABELV $1081
line 2180
;2180:		incoming = DotProduct (normal, lightDir);
ADDRLP4 48
ADDRFP4 0
INDIRP4
ASGNP4
...
GTF4 $1087
line 2182
;2182:			verts[i].modulate[0] = ambientLight[0];
ADDRLP4 56
ADDRLP4 12
INDIRF4
ASGNF4
...
ASGNU1
line 2183
;2183:			verts[i].modulate[1] = ambientLight[1];
ADDRLP4 68
ADDRLP4 12+4
INDIRF4
ASGNF4
...
ASGNU1
line 2184
;2184:			verts[i].modulate[2] = ambientLight[2];
ADDRLP4 80
ADDRLP4 12+8
INDIRF4
ASGNF4
...
line 2188
;2187:		} 
;2188:		j = ( ambientLight[0] + incoming * directedLight[0] );
ADDRLP4 0
ADDRLP4 12
INDIRF4
ADDRLP4 8
...
line 2194
;2193:
;2194:		j = ( ambientLight[1] + incoming * directedLight[1] );
ADDRLP4 0
ADDRLP4 12+4
INDIRF4
ADDRLP4 8
...
line 2200
;2199:
;2200:		j = ( ambientLight[2] + incoming * directedLight[2] );
ADDRLP4 0
ADDRLP4 12+8
INDIRF4
ADDRLP4 8
...
;2214:===============
;2215:*/
;2216:void CG_Player( centity_t *cent ) {
line 2237
;2217:	clientInfo_t	*ci;
;2218:	refEntity_t		legs;
;2219:	refEntity_t		torso;
;2220:	refEntity_t		head;
;2221:	int				clientNum;
;2222:	int				renderfx;
;2223:	qboolean		shadow;
;2224:	float			shadowPlane;
;2225:#ifdef MISSIONPACK
;2226:	refEntity_t		skull;
;2227:	refEntity_t		powerup;
;2228:	int				t;
;2229:	float			c;
;2230:	float			angle;
;2231:	vec3_t			dir, angles;
;2232:#endif
;2233:
;2234:	// the client number is stored in clientNum.  It can't be derived
;2235:	// from the entity number, because a single client may have
;2236:	// multiple corpses on the level using the same clientinfo
;2237:	clientNum = cent->currentState.clientNum;
ADDRLP4 428
ADDRFP4 0
INDIRP4
CNSTI4 168
...
ASGNI4
line 2238
;2238:	if ( clientNum < 0 || clientNum >= MAX_CLIENTS ) {
ADDRLP4 428
INDIRI4
CNSTI4 0
LTI4 $1113
...
LABELV $1113
line 2239
;2239:		CG_Error( "Bad clientNum on player entity");
ADDRGP4 $1114
ARGP4
ADDRGP4 CG_Error
CALLV
...
LABELV $1111
line 2241
;2241:	ci = &cgs.clientinfo[ clientNum ];
ADDRLP4 280
CNSTI4 1708
ADDRLP4 428
INDIRI4
...
line 2245
;2242:
;2243:	// it is possible to see corpses from disconnected players that may
;2244:	// not have valid clientinfo
;2245:	if ( !ci->infoValid ) {
ADDRLP4 280
INDIRP4
INDIRI4
CNSTI4 0
...
;2247:	}
;2248:
;2249:	// get the player model information
;2250:	renderfx = 0;
ADDRLP4 424
CNSTI4 0
ASGNI4
line 2251
;2251:	if ( cent->currentState.number == cg.snap->ps.clientNum) {
ADDRFP4 0
INDIRP4
INDIRI4
ADDRGP4 cg+36
...
NEI4 $1118
line 2252
;2252:		if (!cg.renderingThirdPerson) {
ADDRGP4 cg+107628
INDIRI4
CNSTI4 0
NEI4 $1121
line 2253
;2253:			renderfx = RF_THIRD_PERSON;			// only draw in mirrors
ADDRLP4 424
CNSTI4 2
ASGNI4
line 2254
...
;2260:
;2261:
;2262:	memset( &legs, 0, sizeof(legs) );
ADDRLP4 0
ARGP4
CNSTI4 0
ARGI4
...
pop
line 2263
;2263:	memset( &torso, 0, sizeof(torso) );
ADDRLP4 140
ARGP4
CNSTI4 0
ARGI4
...
pop
line 2264
;2264:	memset( &head, 0, sizeof(head) );
ADDRLP4 284
ARGP4
CNSTI4 0
ARGI4
...
line 2267
;2265:
;2266:	// get the rotation information
;2267:	CG_PlayerAngles( cent, legs.axis, torso.axis, head.axis );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 0+28
...
line 2270
;2268:	
;2269:	// get the animation state (after rotation, to allow feet shuffle)
;2270:	CG_PlayerAnimation( cent, &legs.oldframe, &legs.frame, &legs.backlerp,
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 0+96
...
pop
line 2274
;2271:		 &torso.oldframe, &torso.frame, &torso.backlerp );
;2272:
;2273:	// add the talk baloon or disconnect icon
;2274:	CG_PlayerSprites( cent );
ADDRFP4 0
INDIRP4
ARGP4
...
;2275:
;2276:	// add the shadow
;2277:	shadow = CG_PlayerShadow( cent, &shadowPlane );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 432
...
line 2280
;2278:
;2279:	// add a water splash if partially in and out of water
;2280:	CG_PlayerSplash( cent );
ADDRFP4 0
INDIRP4
ARGP4
...
line 2282
;2281:
;2282:	if ( cg_shadows.integer == 3 && shadow ) {
ADDRGP4 cg_shadows+12
INDIRI4
CNSTI4 3
NEI4 $1136
...
LABELV $1136
line 2285
;2285:	renderfx |= RF_LIGHTING_ORIGIN;			// use the same origin for all
ADDRLP4 424
ADDRLP4 424
INDIRI4
CNSTI4 128
...
;2287:	if( cgs.gametype == GT_HARVESTER ) {
;2288:		CG_PlayerTokens( cent, renderfx );
;2289:	}
;2290:#endif
;2291:	//
;2292:	// add the legs
;2293:	//
;2294:	legs.hModel = ci->legsModel;
ADDRLP4 0+8
ADDRLP4 280
INDIRP4
CNSTI4 516
...
ASGNI4
line 2295
;2295:	legs.customSkin = ci->legsSkin;
ADDRLP4 0+108
ADDRLP4 280
INDIRP4
CNSTI4 520
...
line 2297
;2296:
;2297:	VectorCopy( cent->lerpOrigin, legs.origin );
ADDRLP4 0+68
ADDRFP4 0
INDIRP4
CNSTI4 704
...
line 2299
;2298:
;2299:	VectorCopy( cent->lerpOrigin, legs.lightingOrigin );
ADDRLP4 0+12
ADDRFP4 0
INDIRP4
CNSTI4 704
...
ASGNB 12
line 2300
;2300:	legs.shadowPlane = shadowPlane;
ADDRLP4 0+24
ADDRLP4 432
INDIRF4
ASGNF4
line 2301
;2301:	legs.renderfx = renderfx;
ADDRLP4 0+4
ADDRLP4 424
INDIRI4
ASGNI4
line 2302
;2302:	VectorCopy (legs.origin, legs.oldorigin);	// don't positionally lerp at all
ADDRLP4 0+84
ADDRLP4 0+68
INDIRB
ASGNB 12
line 2304
;2303:
;2304:	CG_AddRefEntityWithPowerups( &legs, &cent->currentState, ci->team );
ADDRLP4 0
ARGP4
ADDRFP4 0
INDIRP4
...
line 2307
;2305:
;2306:	// if the model failed, allow the default nullmodel to be displayed
;2307:	if (!legs.hModel) {
ADDRLP4 0+8
INDIRI4
CNSTI4 0
...
;2312:	// add the torso
;2313:	//
;2314:	torso.hModel = ci->torsoModel;
ADDRLP4 140+8
ADDRLP4 280
INDIRP4
CNSTI4 524
...
;2317:	}
;2318:
;2319:	torso.customSkin = ci->torsoSkin;
ADDRLP4 140+108
ADDRLP4 280
INDIRP4
CNSTI4 528
...
line 2321
;2320:
;2321:	VectorCopy( cent->lerpOrigin, torso.lightingOrigin );
ADDRLP4 140+12
ADDRFP4 0
INDIRP4
CNSTI4 704
...
line 2323
;2322:
;2323:	CG_PositionRotatedEntityOnTag( &torso, &legs, ci->legsModel, "tag_torso");
ADDRLP4 140
ARGP4
ADDRLP4 0
ARGP4
...
line 2325
;2324:
;2325:	torso.shadowPlane = shadowPlane;
ADDRLP4 140+24
ADDRLP4 432
INDIRF4
ASGNF4
line 2326
;2326:	torso.renderfx = renderfx;
ADDRLP4 140+4
ADDRLP4 424
INDIRI4
ASGNI4
line 2328
;2327:
;2328:	CG_AddRefEntityWithPowerups( &torso, &cent->currentState, ci->team );
ADDRLP4 140
ARGP4
ADDRFP4 0
INDIRP4
...
line 2537
;2329:
;2330:#ifdef MISSIONPACK
;2331:	if ( cent->currentState.eFlags & EF_KAMIKAZE ) {
;2332:
;2333:		memset( &skull, 0, sizeof(skull) );
;2334:
;2335:		VectorCopy( cent->lerpOrigin, skull.lightingOrigin );
;2336:		skull.shadowPlane = shadowPlane;
;2337:		skull.renderfx = renderfx;
;2338:
;2339:		if ( cent->currentState.eFlags & EF_DEAD ) {
;2340:			// one skull bobbing above the dead body
;2341:			angle = ((cg.time / 7) & 255) * (M_PI * 2) / 255;
;2342:			if (angle > M_PI * 2)
;2343:				angle -= (float)M_PI * 2;
;2344:			dir[0] = sin(angle) * 20;
;2345:			dir[1] = cos(angle) * 20;
;2346:			angle = ((cg.time / 4) & 255) * (M_PI * 2) / 255;
;2347:			dir[2] = 15 + sin(angle) * 8;
;2348:			VectorAdd(torso.origin, dir, skull.origin);
;2349:			
;2350:			dir[2] = 0;
;2351:			VectorCopy(dir, skull.axis[1]);
;2352:			VectorNormalize(skull.axis[1]);
;2353:			VectorSet(skull.axis[2], 0, 0, 1);
;2354:			CrossProduct(skull.axis[1], skull.axis[2], skull.axis[0]);
;2355:
;2356:			skull.hModel = cgs.media.kamikazeHeadModel;
;2357:			trap_R_AddRefEntityToScene( &skull );
;2358:			skull.hModel = cgs.media.kamikazeHeadTrail;
;2359:			trap_R_AddRefEntityToScene( &skull );
;2360:		}
;2361:		else {
;2362:			// three skulls spinning around the player
;2363:			angle = ((cg.time / 4) & 255) * (M_PI * 2) / 255;
;2364:			dir[0] = cos(angle) * 20;
;2365:			dir[1] = sin(angle) * 20;
;2366:			dir[2] = cos(angle) * 20;
;2367:			VectorAdd(torso.origin, dir, skull.origin);
;2368:
;2369:			angles[0] = sin(angle) * 30;
;2370:			angles[1] = (angle * 180 / M_PI) + 90;
;2371:			if (angles[1] > 360)
;2372:				angles[1] -= 360;
;2373:			angles[2] = 0;
;2374:			AnglesToAxis( angles, skull.axis );
;2375:
;2376:			/*
;2377:			dir[2] = 0;
;2378:			VectorInverse(dir);
;2379:			VectorCopy(dir, skull.axis[1]);
;2380:			VectorNormalize(skull.axis[1]);
;2381:			VectorSet(skull.axis[2], 0, 0, 1);
;2382:			CrossProduct(skull.axis[1], skull.axis[2], skull.axis[0]);
;2383:			*/
;2384:
;2385:			skull.hModel = cgs.media.kamikazeHeadModel;
;2386:			trap_R_AddRefEntityToScene( &skull );
;2387:			// flip the trail because this skull is spinning in the other direction
;2388:			VectorInverse(skull.axis[1]);
;2389:			skull.hModel = cgs.media.kamikazeHeadTrail;
;2390:			trap_R_AddRefEntityToScene( &skull );
;2391:
;2392:			angle = ((cg.time / 4) & 255) * (M_PI * 2) / 255 + M_PI;
;2393:			if (angle > M_PI * 2)
;2394:				angle -= (float)M_PI * 2;
;2395:			dir[0] = sin(angle) * 20;
;2396:			dir[1] = cos(angle) * 20;
;2397:			dir[2] = cos(angle) * 20;
;2398:			VectorAdd(torso.origin, dir, skull.origin);
;2399:
;2400:			angles[0] = cos(angle - 0.5 * M_PI) * 30;
;2401:			angles[1] = 360 - (angle * 180 / M_PI);
;2402:			if (angles[1] > 360)
;2403:				angles[1] -= 360;
;2404:			angles[2] = 0;
;2405:			AnglesToAxis( angles, skull.axis );
;2406:
;2407:			/*
;2408:			dir[2] = 0;
;2409:			VectorCopy(dir, skull.axis[1]);
;2410:			VectorNormalize(skull.axis[1]);
;2411:			VectorSet(skull.axis[2], 0, 0, 1);
;2412:			CrossProduct(skull.axis[1], skull.axis[2], skull.axis[0]);
;2413:			*/
;2414:
;2415:			skull.hModel = cgs.media.kamikazeHeadModel;
;2416:			trap_R_AddRefEntityToScene( &skull );
;2417:			skull.hModel = cgs.media.kamikazeHeadTrail;
;2418:			trap_R_AddRefEntityToScene( &skull );
;2419:
;2420:			angle = ((cg.time / 3) & 255) * (M_PI * 2) / 255 + 0.5 * M_PI;
;2421:			if (angle > M_PI * 2)
;2422:				angle -= (float)M_PI * 2;
;2423:			dir[0] = sin(angle) * 20;
;2424:			dir[1] = cos(angle) * 20;
;2425:			dir[2] = 0;
;2426:			VectorAdd(torso.origin, dir, skull.origin);
;2427:			
;2428:			VectorCopy(dir, skull.axis[1]);
;2429:			VectorNormalize(skull.axis[1]);
;2430:			VectorSet(skull.axis[2], 0, 0, 1);
;2431:			CrossProduct(skull.axis[1], skull.axis[2], skull.axis[0]);
;2432:
;2433:			skull.hModel = cgs.media.kamikazeHeadModel;
;2434:			trap_R_AddRefEntityToScene( &skull );
;2435:			skull.hModel = cgs.media.kamikazeHeadTrail;
;2436:			trap_R_AddRefEntityToScene( &skull );
;2437:		}
;2438:	}
;2439:
;2440:	if ( cent->currentState.powerups & ( 1 << PW_GUARD ) ) {
;2441:		memcpy(&powerup, &torso, sizeof(torso));
;2442:		powerup.hModel = cgs.media.guardPowerupModel;
;2443:		powerup.frame = 0;
;2444:		powerup.oldframe = 0;
;2445:		powerup.customSkin = 0;
;2446:		trap_R_AddRefEntityToScene( &powerup );
;2447:	}
;2448:	if ( cent->currentState.powerups & ( 1 << PW_SCOUT ) ) {
;2449:		memcpy(&powerup, &torso, sizeof(torso));
;2450:		powerup.hModel = cgs.media.scoutPowerupModel;
;2451:		powerup.frame = 0;
;2452:		powerup.oldframe = 0;
;2453:		powerup.customSkin = 0;
;2454:		trap_R_AddRefEntityToScene( &powerup );
;2455:	}
;2456:	if ( cent->currentState.powerups & ( 1 << PW_DOUBLER ) ) {
;2457:		memcpy(&powerup, &torso, sizeof(torso));
;2458:		powerup.hModel = cgs.media.doublerPowerupModel;
;2459:		powerup.frame = 0;
;2460:		powerup.oldframe = 0;
;2461:		powerup.customSkin = 0;
;2462:		trap_R_AddRefEntityToScene( &powerup );
;2463:	}
;2464:	if ( cent->currentState.powerups & ( 1 << PW_AMMOREGEN ) ) {
;2465:		memcpy(&powerup, &torso, sizeof(torso));
;2466:		powerup.hModel = cgs.media.ammoRegenPowerupModel;
;2467:		powerup.frame = 0;
;2468:		powerup.oldframe = 0;
;2469:		powerup.customSkin = 0;
;2470:		trap_R_AddRefEntityToScene( &powerup );
;2471:	}
;2472:	if ( cent->currentState.powerups & ( 1 << PW_INVULNERABILITY ) ) {
;2473:		if ( !ci->invulnerabilityStartTime ) {
;2474:			ci->invulnerabilityStartTime = cg.time;
;2475:		}
;2476:		ci->invulnerabilityStopTime = cg.time;
;2477:	}
;2478:	else {
;2479:		ci->invulnerabilityStartTime = 0;
;2480:	}
;2481:	if ( (cent->currentState.powerups & ( 1 << PW_INVULNERABILITY ) ) ||
;2482:		cg.time - ci->invulnerabilityStopTime < 250 ) {
;2483:
;2484:		memcpy(&powerup, &torso, sizeof(torso));
;2485:		powerup.hModel = cgs.media.invulnerabilityPowerupModel;
;2486:		powerup.customSkin = 0;
;2487:		// always draw
;2488:		powerup.renderfx &= ~RF_THIRD_PERSON;
;2489:		VectorCopy(cent->lerpOrigin, powerup.origin);
;2490:
;2491:		if ( cg.time - ci->invulnerabilityStartTime < 250 ) {
;2492:			c = (float) (cg.time - ci->invulnerabilityStartTime) / 250;
;2493:		}
;2494:		else if (cg.time - ci->invulnerabilityStopTime < 250 ) {
;2495:			c = (float) (250 - (cg.time - ci->invulnerabilityStopTime)) / 250;
;2496:		}
;2497:		else {
;2498:			c = 1;
;2499:		}
;2500:		VectorSet( powerup.axis[0], c, 0, 0 );
;2501:		VectorSet( powerup.axis[1], 0, c, 0 );
;2502:		VectorSet( powerup.axis[2], 0, 0, c );
;2503:		trap_R_AddRefEntityToScene( &powerup );
;2504:	}
;2505:
;2506:	t = cg.time - ci->medkitUsageTime;
;2507:	if ( ci->medkitUsageTime && t < 500 ) {
;2508:		memcpy(&powerup, &torso, sizeof(torso));
;2509:		powerup.hModel = cgs.media.medkitUsageModel;
;2510:		powerup.customSkin = 0;
;2511:		// always draw
;2512:		powerup.renderfx &= ~RF_THIRD_PERSON;
;2513:		VectorClear(angles);
;2514:		AnglesToAxis(angles, powerup.axis);
;2515:		VectorCopy(cent->lerpOrigin, powerup.origin);
;2516:		powerup.origin[2] += -24 + (float) t * 80 / 500;
;2517:		if ( t > 400 ) {
;2518:			c = (float) (t - 1000) * 0xff / 100;
;2519:			powerup.shaderRGBA[0] = 0xff - c;
;2520:			powerup.shaderRGBA[1] = 0xff - c;
;2521:			powerup.shaderRGBA[2] = 0xff - c;
;2522:			powerup.shaderRGBA[3] = 0xff - c;
;2523:		}
;2524:		else {
;2525:			powerup.shaderRGBA[0] = 0xff;
;2526:			powerup.shaderRGBA[1] = 0xff;
;2527:			powerup.shaderRGBA[2] = 0xff;
;2528:			powerup.shaderRGBA[3] = 0xff;
;2529:		}
;2530:		trap_R_AddRefEntityToScene( &powerup );
;2531:	}
;2532:#endif // MISSIONPACK
;2533:
;2534:	//
;2535:	// add the head
;2536:	//
;2537:	head.hModel = ci->headModel;
ADDRLP4 284+8
ADDRLP4 280
INDIRP4
CNSTI4 532
...
line 2541
;2540:	}
;2541:	head.customSkin = ci->headSkin;
ADDRLP4 284+108
ADDRLP4 280
INDIRP4
CNSTI4 536
...
line 2543
;2542:
;2543:	VectorCopy( cent->lerpOrigin, head.lightingOrigin );
ADDRLP4 284+12
ADDRFP4 0
INDIRP4
CNSTI4 704
...
line 2545
;2544:
;2545:	CG_PositionRotatedEntityOnTag( &head, &torso, ci->torsoModel, "tag_head");
ADDRLP4 284
ARGP4
ADDRLP4 140
ARGP4
...
line 2547
;2546:
;2547:	head.shadowPlane = shadowPlane;
ADDRLP4 284+24
ADDRLP4 432
INDIRF4
ASGNF4
line 2548
;2548:	head.renderfx = renderfx;
ADDRLP4 284+4
ADDRLP4 424
INDIRI4
ASGNI4
line 2550
;2549:
;2550:	CG_AddRefEntityWithPowerups( &head, &cent->currentState, ci->team );
ADDRLP4 284
ARGP4
ADDRFP4 0
INDIRP4
...
line 2561
;2551:
;2552:#ifdef MISSIONPACK
;2553:	CG_BreathPuffs(cent, &head);
;2554:
;2555:	CG_DustTrail(cent);
;2556:#endif
;2557:
;2558:	//
;2559:	// add the gun / barrel / flash
;2560:	//
;2561:	CG_AddPlayerWeapon( &torso, NULL, cent, ci->team );
ADDRLP4 140
ARGP4
CNSTP4 0
ARGP4
...
line 2564
;2562:
;2563:	// add powerups floating behind the player
;2564:	CG_PlayerPowerups( cent, &torso );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 140
...
;2570:/*
;2571:===============
;2572:CG_ResetPlayerEntity
;2573:
;2574:A player just came into view or teleported, so reset all animation info
;2575:===============
;2576:*/
;2577:void CG_ResetPlayerEntity( centity_t *cent ) {
line 2578
;2578:	cent->errorTime = -99999;		// guarantee no error decay added
ADDRFP4 0
INDIRP4
CNSTI4 636
ADDP4
...
line 2581
;2580:
;2581:	CG_ClearLerpFrame( &cgs.clientinfo[ cent->currentState.clientNum ], &cent->pe.legs, cent->currentState.legsAnim );
ADDRLP4 0
ADDRFP4 0
INDIRP4
ASGNP4
...
pop
line 2582
;2582:	CG_ClearLerpFrame( &cgs.clientinfo[ cent->currentState.clientNum ], &cent->pe.torso, cent->currentState.torsoAnim );
ADDRLP4 4
ADDRFP4 0
INDIRP4
ASGNP4
...
line 2584
;2583:
;2584:	BG_EvaluateTrajectory( &cent->currentState.pos, cg.time, cent->lerpOrigin );
ADDRLP4 8
ADDRFP4 0
INDIRP4
ASGNP4
...
pop
line 2585
;2585:	BG_EvaluateTrajectory( &cent->currentState.apos, cg.time, cent->lerpAngles );
ADDRLP4 12
ADDRFP4 0
INDIRP4
ASGNP4
...
line 2587
;2586:
;2587:	VectorCopy( cent->lerpOrigin, cent->rawOrigin );
ADDRLP4 16
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNB 12
line 2588
;2588:	VectorCopy( cent->lerpAngles, cent->rawAngles );
ADDRLP4 20
ADDRFP4 0
INDIRP4
ASGNP4
...
line 2590
;2589:
;2590:	memset( &cent->pe.legs, 0, sizeof( cent->pe.legs ) );
ADDRFP4 0
INDIRP4
CNSTI4 452
ADDP4
...
pop
line 2591
;2591:	cent->pe.legs.yawAngle = cent->rawAngles[YAW];
ADDRLP4 24
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNF4
line 2592
;2592:	cent->pe.legs.yawing = qfalse;
ADDRFP4 0
INDIRP4
CNSTI4 476
ADDP4
...
ASGNI4
line 2593
;2593:	cent->pe.legs.pitchAngle = 0;
ADDRFP4 0
INDIRP4
CNSTI4 480
ADDP4
...
ASGNF4
line 2594
;2594:	cent->pe.legs.pitching = qfalse;
ADDRFP4 0
INDIRP4
CNSTI4 484
ADDP4
...
line 2596
;2595:
;2596:	memset( &cent->pe.torso, 0, sizeof( cent->pe.legs ) );
ADDRFP4 0
INDIRP4
CNSTI4 500
ADDP4
...
pop
line 2597
;2597:	cent->pe.torso.yawAngle = cent->rawAngles[YAW];
ADDRLP4 28
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNF4
line 2598
;2598:	cent->pe.torso.yawing = qfalse;
ADDRFP4 0
INDIRP4
CNSTI4 524
ADDP4
...
ASGNI4
line 2599
;2599:	cent->pe.torso.pitchAngle = cent->rawAngles[PITCH];
ADDRLP4 32
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNF4
line 2600
;2600:	cent->pe.torso.pitching = qfalse;
ADDRFP4 0
INDIRP4
CNSTI4 532
ADDP4
...
line 2602
;2601:
;2602:	if ( cg_debugPosition.integer ) {
ADDRGP4 cg_debugPosition+12
INDIRI4
CNSTI4 0
EQI4 $1173
line 2603
;2603:		CG_Printf("%i ResetPlayerEntity yaw=%i\n", cent->currentState.number, cent->pe.torso.yawAngle );
ADDRGP4 $1176
ARGP4
ADDRLP4 36
ADDRFP4 0
