...
line 1866
;1865:
;1866:	cgs.redflag = cgs.blueflag = -1; // For compatibily, default to unset for
ADDRLP4 24
CNSTI4 -1
ASGNI4
ADDRGP4 cgs+34812
...
;1868:	// old servers
;1869:
;1870:	// get the rendering configuration from the client system
;1871:	trap_GetGlconfig( &cgs.glconfig );
ADDRGP4 cgs+20100
ARGP4
...
pop
line 1872
;1872:	cgs.screenXScale = cgs.glconfig.vidWidth / 640.0;
ADDRGP4 cgs+31432
...
ASGNF4
line 1873
;1873:	cgs.screenYScale = cgs.glconfig.vidHeight / 480.0;
ADDRGP4 cgs+31436
...
line 1876
;1874:
;1875:	// get the gamestate from the client system
;1876:	trap_GetGameState( &cgs.gameState );
ADDRGP4 cgs
ARGP4
...
;1877:
;1878:	// check version
;1879:	s = CG_ConfigString( CS_GAME_VERSION );
CNSTI4 20
ARGI4
ADDRLP4 28
ADDRGP4 CG_ConfigString
...
EQI4 $953
line 1881
;1881:		CG_Error( "Client/Server game mismatch: %s/%s", GAME_VERSION, s );
ADDRGP4 $956
ARGP4
ADDRGP4 $955
ARGP4
...
line 1884
;1883:
;1884:	s = CG_ConfigString( CS_LEVEL_START_TIME );
CNSTI4 21
ARGI4
ADDRLP4 36
ADDRGP4 CG_ConfigString
...
ASGNP4
line 1885
;1885:	cgs.levelStartTime = atoi( s );
ADDRLP4 0
INDIRP4
ARGP4
ADDRLP4 40
...
line 1887
;1886:
;1887:	CG_ParseServerinfo();
ADDRGP4 CG_ParseServerinfo
CALLV
pop
line 1890
;1888:
;1889:	// load the new map
;1890:	CG_LoadingString( "collision map" );
ADDRGP4 $958
ARGP4
ADDRGP4 CG_LoadingString
CALLV
...
line 1892
;1891:
;1892:	trap_CM_LoadMap( cgs.mapname );
ADDRGP4 cgs+31484
ARGP4
...
line 1898
;1893:
;1894:#ifdef MISSIONPACK
;1895:	String_Init();
;1896:#endif
;1897:
;1898:	cg.loading = qtrue;		// force players to load instead of defer
ADDRGP4 cg+20
CNSTI4 1
ASGNI4
line 1900
;1899:
;1900:	CG_LoadingString( "sounds" );
ADDRGP4 $961
ARGP4
ADDRGP4 CG_LoadingString
CALLV
...
line 1902
;1901:
;1902:	CG_RegisterSounds();
ADDRGP4 CG_RegisterSounds
CALLV
pop
line 1904
;1903:
;1904:	CG_LoadingString( "graphics" );
ADDRGP4 $962
ARGP4
ADDRGP4 CG_LoadingString
CALLV
...
line 1906
;1905:
;1906:	CG_RegisterGraphics();
ADDRGP4 CG_RegisterGraphics
CALLV
pop
line 1908
;1907:
;1908:	CG_LoadingString( "clients" );
ADDRGP4 $963
ARGP4
ADDRGP4 CG_LoadingString
CALLV
...
line 1910
;1909:
;1910:	CG_RegisterClients();		// if low on memory, some clients will be deferred
...
;1913:	CG_AssetCache();
;1914:	CG_LoadHudMenu();      // load new hud stuff
;1915:#endif
;1916:
;1917:	cg.loading = qfalse;	// future players will be deferred
ADDRGP4 cg+20
CNSTI4 0
ASGNI4
line 1919
;1918:
;1919:	CG_InitLocalEntities();
ADDRGP4 CG_InitLocalEntities
CALLV
pop
line 1921
;1920:
;1921:	CG_InitMarkPolys();
ADDRGP4 CG_InitMarkPolys
CALLV
pop
line 1924
;1922:
;1923:	// remove the last loading update
;1924:	cg.infoScreenText[0] = 0;
ADDRGP4 cg+109436
CNSTI1 0
ASGNI1
line 1927
;1925:
;1926:	// Make sure we have update values (scores)
;1927:	CG_SetConfigValues();
...
;1934:	CG_InitTeamChat();
;1935:#endif
;1936:
;1937:	CG_ShaderStateChanged();
ADDRGP4 CG_ShaderStateChanged
CALLV
pop
line 1939
;1938:
;1939:	trap_S_ClearLoopingSounds( qtrue );
CNSTI4 1
ARGI4
...
;1944:CG_Shutdown
;1945:
;1946:Called before every level change or subsystem restart
;1947:=================
;1948:*/
;1949:void CG_Shutdown( void ) {
line 1952
;1950:	// some mods may need to do cleanup work here,
;1951:	// like closing files or archiving session data
;1952:}
LABELV $967
...
;1955:/*
;1956:==================
;1957:CG_EventHandling
;1958:==================
;1959: type 0 - no event handling
;1960:      1 - team menu
;1961:      2 - hud editor
;1962:
;1963:*/
;1964:#ifndef MISSIONPACK
;1965:void CG_EventHandling(int type) {
line 1966
;1966:}
LABELV $968
...
;1968:
;1969:
;1970:void CG_KeyEvent(int key, qboolean down) {
line 1971
;1971:}
LABELV $969
...
line 1973
;1972:
;1973:void CG_MouseEvent(int x, int y) {
line 1974
;1974:}
LABELV $970
