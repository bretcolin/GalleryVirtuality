...
#define MIN_COMHUNKMEGS 64			//56
#ifdef MACOS_X
#define DEF_COMHUNKMEGS "64"
#define DEF_COMZONEMEGS "24"
#else
#define DEF_COMHUNKMEGS "128"		//56
#define DEF_COMZONEMEGS "64"		//16
#endif
...
//	Swap_Init ();
  ...
  // get dedicated here for proper hunk megs initialization
	...
	s = va("%s %s %s", G1_VERSION, CPUSTRING, __DATE__ );
