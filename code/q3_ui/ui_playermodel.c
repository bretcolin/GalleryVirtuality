...
static void PlayerModel_UpdateModel( void )
{
	...
	UI_PlayerInfo_SetInfo( &s_playermodel.playerinfo, LEGS_IDLE, TORSO_STAND, viewangles, moveangles, WP_HAND, qfalse );
}
...
*/
	...
	for (i=0,k=0; i<PLAYERGRID_ROWS; i++)
	{
		...
		for (j=0; j<PLAYERGRID_COLS; j++,k++)
		{
			...
			s_playermodel.picbuttons[k].focuscolor  	 = colorYellow;
