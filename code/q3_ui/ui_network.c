...
*/
	...
	networkOptionsInfo.graphics.color				= color_yellow;
	...
	networkOptionsInfo.display.color				= color_yellow;
	...
	networkOptionsInfo.sound.color					= color_yellow;
...
//	networkOptionsInfo.network.color				= color_yellow;
