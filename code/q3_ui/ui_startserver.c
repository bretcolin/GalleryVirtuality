...
static void StartServer_MenuInit( void ) {
	...
	s_startserver.banner.string        = "GALLERIES";
...
*/
	...
	s_startserver.gametype.generic.name		= "Gallery:";
...
static void ServerOptions_MenuInit( qboolean multiplayer ) {
	...
	s_serveroptions.banner.string  				= "GALLERY";
	...
	s_serveroptions.mappic.generic.flags		= QMF_CENTER_JUSTIFY|QMF_INACTIVE;
	s_serveroptions.mappic.generic.x			= 352;
	s_serveroptions.mappic.generic.y			= 80;
	s_serveroptions.mappic.width				= 320;
	s_serveroptions.mappic.height				= 240;
