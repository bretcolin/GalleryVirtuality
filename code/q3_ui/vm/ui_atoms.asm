...
;1009:	}
;1010:
;1011: 	if ( Q_stricmp (cmd, "ui_dynamicmenu") == 0 ) {
ADDRLP4 0
INDIRP4
ARGP4
ADDRGP4 $414
...
;1014:    }
;1015:
;1016:	if ( Q_stricmp (cmd, "ui_teamOrders") == 0 ) {
ADDRLP4 0
INDIRP4
ARGP4
ADDRGP4 $417
...
;1019:	}
;1020:
;1021:	if ( Q_stricmp (cmd, "iamacheater") == 0 ) {
ADDRLP4 0
INDIRP4
ARGP4
ADDRGP4 $420
...
;1024:	}
;1025:
;1026:	if ( Q_stricmp (cmd, "iamamonkey") == 0 ) {
ADDRLP4 0
INDIRP4
ARGP4
ADDRGP4 $423
...
;1029:	}
;1030:
;1031://	if ( Q_stricmp (cmd, "ui_cdkey") == 0 ) {
;1032://		UI_CDKeyMenu_f();
;1033://		return qtrue;
;1034://	}
;1035:
...
;1050:=================
;1051:*/
;1052:void UI_Init( void ) {
line 1053
;1053:	UI_RegisterCvars();
ADDRGP4 UI_RegisterCvars
CALLV
pop
line 1055
;1054:
;1055:	UI_InitGameinfo();
ADDRGP4 UI_InitGameinfo
CALLV
pop
line 1058
;1056:
;1057:	// cache redundant calulations
;1058:	trap_GetGlconfig( &uis.glconfig );
ADDRGP4 uis+56
ARGP4
...
line 1061
;1059:
;1060:	// for 640x480 virtualized screen
;1061:	uis.scale = uis.glconfig.vidHeight * (1.0/480.0);
ADDRGP4 uis+11432
CNSTF4 990414985
...
ASGNF4
line 1062
;1062:	if ( uis.glconfig.vidWidth * 480 > uis.glconfig.vidHeight * 640 ) {
CNSTI4 480
...
line 1064
;1063:		// wide screen
;1064:		uis.bias = 0.5 * ( uis.glconfig.vidWidth - ( uis.glconfig.vidHeight * (640.0/480.0) ) );
ADDRGP4 uis+11436
CNSTF4 1056964608
ADDRGP4 uis+56+11304
INDIRI4
...
line 1072
;1070:
;1071:	// initialize the menu system
;1072:	Menu_Cache();
ADDRGP4 Menu_Cache
CALLV
pop
...
line 1093
;1092:
;1093:void UI_DrawNamedPic( float x, float y, float width, float height, const char *picname ) {
line 1096
;1094:	qhandle_t	hShader;
;1095:
;1096:	hShader = trap_R_RegisterShaderNoMip( picname );
ADDRFP4 16
INDIRP4
ARGP4
ADDRLP4 4
...
ASGNI4
line 1097
;1097:	UI_AdjustFrom640( &x, &y, &width, &height );
ADDRFP4 0
ARGP4
ADDRFP4 4
ARGP4
...
pop
line 1098
;1098:	trap_R_DrawStretchPic( x, y, width, height, 0, 0, 1, 1, hShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
line 1101
;1100:
;1101:void UI_DrawHandlePic( float x, float y, float w, float h, qhandle_t hShader ) {
line 1107
;1102:	float	s0;
;1103:	float	s1;
;1104:	float	t0;
;1105:	float	t1;
;1106:
;1107:	if( w < 0 ) {	// flip about vertical
ADDRFP4 8
INDIRF4
CNSTF4 0
GEF4 $452
...
line 1117
;1116:
;1117:	if( h < 0 ) {	// flip about horizontal
ADDRFP4 12
INDIRF4
CNSTF4 0
GEF4 $454
...
pop
line 1128
;1128:	trap_R_DrawStretchPic( x, y, w, h, s0, t0, s1, t1, hShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
;1133:UI_FillRect
;1134:
;1135:Coordinates are 640*480 virtual values
;1136:=================
;1137:*/
;1138:void UI_FillRect( float x, float y, float width, float height, const float *color ) {
line 1139
;1139:	trap_R_SetColor( color );
ADDRFP4 16
INDIRP4
ARGP4
ADDRGP4 trap_R_SetColor
...
line 1141
;1140:
;1141:	UI_AdjustFrom640( &x, &y, &width, &height );
ADDRFP4 0
ARGP4
ADDRFP4 4
ARGP4
...
pop
line 1142
;1142:	trap_R_DrawStretchPic( x, y, width, height, 0, 0, 0, 0, uis.whiteShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
;1149:UI_DrawRect
;1150:
;1151:Coordinates are 640*480 virtual values
;1152:=================
;1153:*/
;1154:void UI_DrawRect( float x, float y, float width, float height, const float *color ) {
line 1155
...
line 1157
;1156:
;1157:	UI_AdjustFrom640( &x, &y, &width, &height );
ADDRFP4 0
ARGP4
ADDRFP4 4
ARGP4
...
line 1159
;1158:
;1159:	trap_R_DrawStretchPic( x, y, width, 1, 0, 0, 0, 0, uis.whiteShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
pop
line 1160
;1160:	trap_R_DrawStretchPic( x, y, 1, height, 0, 0, 0, 0, uis.whiteShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
pop
line 1161
;1161:	trap_R_DrawStretchPic( x, y + height - 1, width, 1, 0, 0, 0, 0, uis.whiteShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRLP4 8
...
pop
line 1162
;1162:	trap_R_DrawStretchPic( x + width - 1, y, 1, height, 0, 0, 0, 0, uis.whiteShader );
ADDRLP4 16
CNSTF4 1065353216
ASGNF4
ADDRFP4 0
...
line 1167
;1166:
;1167:void UI_SetColor( const float *rgba ) {
line 1168
;1168:	trap_R_SetColor( rgba );
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 trap_R_SetColor
...
line 1171
;1170:
;1171:void UI_UpdateScreen( void ) {
line 1172
;1172:	trap_UpdateScreen();
...
;1178:=================
;1179:*/
;1180:void UI_Refresh( int realtime )
;1181:{
line 1182
;1182:	uis.frametime = realtime - uis.realtime;
ADDRGP4 uis
ADDRFP4 0
INDIRI4
ADDRGP4 uis+4
...
line 1185
;1184:
;1185:	if ( !( trap_Key_GetCatcher() & KEYCATCH_UI ) ) {
ADDRLP4 0
ADDRGP4 trap_Key_GetCatcher
CALLI4
ASGNI4
...
;1192:	{
line 1193
;1193:		if (uis.activemenu->fullscreen)
ADDRGP4 uis+20
INDIRP4
CNSTI4 280
ADDP4
...
;1194:		{
line 1196
;1195:			// draw the background
;1196:			if( uis.activemenu->showlogo ) {
ADDRGP4 uis+20
INDIRP4
CNSTI4 284
ADDP4
...
EQI4 $476
line 1197
;1197:				UI_DrawHandlePic( 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, uis.menuBackShader );
ADDRLP4 4
CNSTF4 0
ASGNF4
ADDRLP4 4
...
;1199:			else {
line 1200
;1200:				UI_DrawHandlePic( 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, uis.menuBackNoLogoShader );
ADDRLP4 4
CNSTF4 0
ASGNF4
ADDRLP4 4
...
line 1209
;1208:
;1209:		if( uis.firstdraw ) {
ADDRGP4 uis+11444
INDIRI4
CNSTI4 0
EQI4 $486
line 1210
;1210:			UI_MouseEvent( 0, 0 );
ADDRLP4 4
CNSTI4 0
ASGNI4
ADDRLP4 4
...
pop
line 1217
;1217:	UI_DrawHandlePic( uis.cursorx-16, uis.cursory-16, 32, 32, uis.cursor);
ADDRLP4 4
CNSTI4 16
ASGNI4
ADDRGP4 uis+8
...
;1221:	{
line 1223
;1222:		// cursor coordinates
;1223:		UI_DrawString( 0, 0, va("(%d,%d)",uis.cursorx,uis.cursory), UI_LEFT|UI_SMALLFONT, colorRed );
ADDRGP4 $496
ARGP4
ADDRGP4 uis+8
INDIRI4
...
;1225:#endif
;1226:
;1227:	// delay playing the enter sound until after the
;1228:	// menu has been drawn, to avoid delay while
;1229:	// caching images
;1230:	if (m_entersound)
ADDRGP4 m_entersound
INDIRI4
CNSTI4 0
EQI4 $499
...
;1231:	{
line 1232
;1232:		trap_S_StartLocalSound( menu_in_sound, CHAN_LOCAL_SOUND );
...
line 1238
;1236:
;1237:void UI_DrawTextBox (int x, int y, int width, int lines)
;1238:{
line 1239
;1239:	UI_FillRect( x + BIGCHAR_WIDTH/2, y + BIGCHAR_HEIGHT/2, ( width + 1 ) * BIGCHAR_WIDTH, ( lines + 1 ) * BIGCHAR_HEIGHT, colorBlack );
ADDRLP4 0
CNSTI4 8
ASGNI4
ADDRFP4 0
...
pop
line 1240
;1240:	UI_DrawRect( x + BIGCHAR_WIDTH/2, y + BIGCHAR_HEIGHT/2, ( width + 1 ) * BIGCHAR_WIDTH, ( lines + 1 ) * BIGCHAR_HEIGHT, colorWhite );
ADDRLP4 12
CNSTI4 8
ASGNI4
ADDRFP4 0
...
line 1244
;1242:
;1243:qboolean UI_CursorInRect (int x, int y, int width, int height)
;1244:{
line 1245
;1245:	if (uis.cursorx < x ||
ADDRLP4 0
ADDRFP4 0
INDIRI4
ASGNI4
...
line 1249
;1246:		uis.cursory < y ||
;1247:		uis.cursorx > x+width ||
;1248:		uis.cursory > y+height)
;1249:		return qfalse;
CNSTI4 0
RETI4
ADDRGP4 $502
