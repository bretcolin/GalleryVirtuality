...
*/
	...
	s_graphicsoptions.graphics.color			= color_yellow;
	...
	s_graphicsoptions.display.color				= color_yellow;
	...
	s_graphicsoptions.sound.color				= color_yellow;
	...
	s_graphicsoptions.network.color				= color_yellow;
	...
	s_graphicsoptions.driverinfo.color            = color_yellow;
	y += BIGCHAR_HEIGHT+2;
