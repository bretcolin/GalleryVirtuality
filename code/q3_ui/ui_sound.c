...
*/
	...
	soundOptionsInfo.graphics.color				= color_yellow;
	...
	soundOptionsInfo.display.color				= color_yellow;
	...
	soundOptionsInfo.sound.color				= color_yellow;
	...
	soundOptionsInfo.network.color				= color_yellow;
