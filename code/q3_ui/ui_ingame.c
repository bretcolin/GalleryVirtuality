...
#define ID_LEAVEGALLERY			15
#define ID_RESTARTGALLERY				16
#define ID_QUIT					17
#define ID_RESUME				18
...
//	menutext_s		team;
	menutext_s		setup;
//	menutext_s		server;
	menutext_s		leavegallery;
	menutext_s		restartgallery;
//	menutext_s		addbots;
...
//		break;
	...
	case ID_LEAVEGALLERY:
		trap_Cmd_ExecuteText( EXEC_APPEND, "disconnect\n" );
		break;

	case ID_RESTARTGALLERY:
		UI_ConfirmMenu( "RESTART GALLERY?", (voidfunc_f)NULL, InGame_RestartAction );
		break;
...
//	s_ingame.team.color					= color_yellow;
...
//	s_ingame.addbots.color				= color_yellow;
...
//	s_ingame.removebots.color				= color_yellow;
...
//	s_ingame.teamorders.color				= color_yellow;
...
//	}
	...
	s_ingame.setup.color				= color_yellow;
...
//	s_ingame.server.color				= color_yellow;
//	s_ingame.server.style				= UI_CENTER|UI_SMALLFONT;

	y += INGAME_MENU_VERTICAL_SPACING;
	s_ingame.restartgallery.generic.type		= MTYPE_PTEXT;
	s_ingame.restartgallery.generic.flags		= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS;
	s_ingame.restartgallery.generic.x			= 320;
	s_ingame.restartgallery.generic.y			= y;
	s_ingame.restartgallery.generic.id			= ID_RESTARTGALLERY;
	s_ingame.restartgallery.generic.callback	= InGame_Event; 
	s_ingame.restartgallery.string				= "RESTART GALLERY";
	s_ingame.restartgallery.color				= color_yellow;
	s_ingame.restartgallery.style				= UI_CENTER|UI_SMALLFONT;
	if( !trap_Cvar_VariableValue( "sv_running" ) ) {
		s_ingame.restartgallery.generic.flags |= QMF_GRAYED;
	}
	...
	s_ingame.resume.color					= color_yellow;
	s_ingame.resume.style					= UI_CENTER|UI_SMALLFONT;

	y += INGAME_MENU_VERTICAL_SPACING;
	s_ingame.leavegallery.generic.type			= MTYPE_PTEXT;
	s_ingame.leavegallery.generic.flags		= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS;
	s_ingame.leavegallery.generic.x			= 320;
	s_ingame.leavegallery.generic.y			= y;
	s_ingame.leavegallery.generic.id			= ID_LEAVEGALLERY;
	s_ingame.leavegallery.generic.callback		= InGame_Event; 
	s_ingame.leavegallery.string				= "LEAVE GALLERY";
	s_ingame.leavegallery.color				= color_yellow;
	s_ingame.leavegallery.style				= UI_CENTER|UI_SMALLFONT;
	...
	s_ingame.quit.color					= color_yellow;
...
//	Menu_AddItem( &s_ingame.menu, &s_ingame.server );
	Menu_AddItem( &s_ingame.menu, &s_ingame.restartgallery );
	Menu_AddItem( &s_ingame.menu, &s_ingame.resume );
	Menu_AddItem( &s_ingame.menu, &s_ingame.leavegallery );
...
{
	UI_DrawString(0, 0, va("This Gallery was built", s_dynamic.depth), 
		UI_SMALLFONT, color_white);
	UI_DrawString(0, 32, va("by artists for artists.",
