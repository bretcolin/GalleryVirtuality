...
//	setupMenuInfo.setupplayer.color					= color_yellow;
...
//	setupMenuInfo.setupcontrols.color				= color_yellow;
//	setupMenuInfo.setupcontrols.style				= UI_CENTER;
	...
	setupMenuInfo.setupsystem.color					= color_yellow;
	...
	setupMenuInfo.game.string						= "GALLERY OPTIONS";
	setupMenuInfo.game.color						= color_yellow;
...
/*
	...
	setupMenuInfo.cdkey.color						= color_yellow;
...
*/
	if( !trap_Cvar_VariableValue( "cl_paused" ) ) {
		...
		setupMenuInfo.load.color						= color_yellow;
		...
		setupMenuInfo.save.color						= color_yellow;
...
//		setupMenuInfo.defaults.color					= color_yellow;
