...
*/
	...
	displayOptionsInfo.graphics.color				= color_yellow;
	...
	displayOptionsInfo.display.color				= color_yellow;
	...
	displayOptionsInfo.sound.color					= color_yellow;
	...
	displayOptionsInfo.network.color				= color_yellow;
