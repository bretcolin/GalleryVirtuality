...
//	UI_DrawNamedPic( 142, 118, 359, 256, ART_CONFIRM_FRAME );
	...
	{
		UI_DrawProportionalString( 320, y, s_confirm.lines[i], s_confirm.style, color_yellow );
		y += 18;
	}
...
//	UI_DrawNamedPic( 142, 118, 359, 256, ART_CONFIRM_FRAME );
	UI_DrawProportionalString( 320, 204, s_confirm.question, s_confirm.style, color_yellow );
	UI_DrawProportionalString( s_confirm.slashX, 265, "/", UI_LEFT|UI_INVERSE, color_yellow );
...
void UI_ConfirmMenu_Style( const char *question, int style, void (*draw)( void ), void (*action)( qboolean result ) ) {
	...
	s_confirm.yes.color				= color_yellow;
	...
	s_confirm.no.color			    = color_yellow;
